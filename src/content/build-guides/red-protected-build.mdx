...
<ChecklistItem id="red-protected-build-1" label="No behavioral tracking or profiling — no analytics that track individual behavior patterns" />
...
In the US, COPPA applies to children under 13. In the EU, GDPR Article 8 sets thresholds between 13-16 depending on the country. Springpod policy may set stricter limits. These protections cover the common requirements across most jurisdictions. Check your [Company Context](/client-config/company-context) for your specific compliance requirements.
