...
<Collapsible variant="how" title="HOW TO answer">
...
If your tool has a chatbot, summariser, or any feature where AI writes text that users read — that is "generates content." If AI scores applicants, filters results, or recommends actions — that is "makes decisions."
